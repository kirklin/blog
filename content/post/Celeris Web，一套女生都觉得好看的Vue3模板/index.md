---
title: Celeris Web，一套女生都觉得好看的Vue3模板
description:
date: 2024-01-16
image: banner.png
categories: [ "前端","Vue3"]
...
嗯，女生总是很喜欢漂亮的东西，对吧？于是我决定写一款前端开发模板，让开发出来的工具她们用起来不仅方便，还得有点美美哒。Vue 3、Unocss、NaiveUI、Monorepo，这些都是我的秘密武器。我取名它为**Celeris Web**。
